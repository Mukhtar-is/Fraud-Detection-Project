...
•	Model performance:
o	Decision Tree: Recall 80%, Precision 84%
o	Linear Discriminant Analysis (LDA): Recall 81%, Precision 88% (best balance)
o	Logistic Regression and KNN underperformed on recall.
## Business Impact
